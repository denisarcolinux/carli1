...
# Author 	: 	Deni Cosovic
# Website 	: 	No Websiite, leanning ar
# This is only for learning purposes of myself
##################################################################################################################
##################################################################################################################
#
...
case $CHOICE in
    ...
    1 )
			...
			git config --global user.name "Deni Arco"
			git config --global user.email "denisarcolinux@gmail.com"
